...
# Push Buttons
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { btn_i[0] }]; #IO_L6P_T0_34 Sch=btn[0]
set_property -dict { PACKAGE_PIN D1    IOSTANDARD LVCMOS33 } [get_ports { btn_i[1] }]; #IO_L6N_T0_VREF_34 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { i2c_scl_io }]; #IO_L11P_T1_SRCC_14 Sch=pio[16]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { i2c_sda_io }]; #IO_L11N_T1_SRCC_14 Sch=pio[17]
...
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_o }]; #IO_L9N_T1_DQS_D13_14 Sch=pio[21]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { uart_dtr_i }]; #IO_L9P_T1_DQS_14 Sch=pio[22]
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { uart_rx_i }]; #IO_L4N_T0_D05_14 Sch=pio[23]
