...
set_property -dict { PACKAGE_PIN A2    IOSTANDARD LVCMOS33 } [get_ports { i2c_scl_io }]; #IO_L2N_T0_34 Sch=pio[41]
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { i2c_sda_io }]; #IO_L2P_T0_34 Sch=pio[42]
